...
def analyze_weights_img(gen_output):
    ...
    img_raw_005_to_03 = img_raw.detach().clone()
    img_raw_005_to_03[~mask_005_to_03] = -1
    img_raw_005_to_05 = img_raw.detach().clone()
    img_raw_005_to_05[~mask_005_to_05] = -1
    img_raw_005_to_07 = img_raw.detach().clone()
    img_raw_005_to_07[~mask_005_to_07] = -1
    img_raw_005_to_09 = img_raw.detach().clone()
    img_raw_005_to_09[~mask_005_to_09] = -1
    img_raw_005_to_10 = img_raw.detach().clone()
...
class GeneFace2Infer:
    ...
    def prepare_batch_from_inp(self, inp):
        ...
        if inp['drv_audio_name'][-4:] in ['.wav', '.mp3']:
            ...
            drv_motion_coeff_dict = fit_3dmm_for_a_video(inp['drv_audio_name'], save=True)
        ...
        coeff_dict = fit_3dmm_for_a_image(image_name, save=True)
