...
def transcribe_speech(filename):    # 음성을 텍스트로(STT) # whisper model오픈소스
...
def main():
    ...
    while True:
        ...
        csv_file_path = './records/records_whisper_model.csv'
        df.to_csv(csv_file_path, index=False)
        latency_csv_file_path = './records/latency_records_whisper_model.csv'
